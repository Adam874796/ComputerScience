...
"""
Author : Adam Saad
   Revison date : December 20th 2024
   Program : ICS4U0-1
...
def get_numeric(data: str):
    # PreConditions: Parse a string of points in the format "(x, y), (x, y), ...".
...
print("The perimeter is:", Poly.perimeter()) # output the perimeter.
print("The area is:", Poly.area()) # output the area
Poly.draw() # draw the polygon to show if it is regular or irregular
